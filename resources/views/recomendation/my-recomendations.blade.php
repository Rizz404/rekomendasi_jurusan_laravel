            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <form
                            action="{{ route('my-recommendations.calculate') }}"
                            method="POST">
                            @csrf
                            <button type="submit"
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="py-4 px-4">
                                                <div
                                                    ...
                                                    {{ $recommendation->final_score >= 80 ? 'text-green-600' : ($recommendation->final_score >= 60 ? 'text-blue-600' : ($recommendation->final_score >= 40 ? 'text-yellow-600' : 'text-red-600')) }}">
                                            ...
                                            <td class="py-4 px-4">
                                                <a href="{{ route('college-majors.show', $recommendation->college_major_id) }}"
                                                    class="text-blue-600 hover:text-blue-900">Detail
                                                    Jurusan</a>
                                            </td>
                                        </tr>
                                    @endforeach
