...
class CollegeMajorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.admin.college-major.index', compact('collegeMajors'));
    }
    ...
    {
        return view('pages.admin.college-major.create');
    }
    ...
    public function show(CollegeMajor $collegeMajor)
    {
        ...
        return view("pages.admin.college-major.show", compact('collegeMajor'));
    }
    ...
    {
        return view("pages.admin.college-major.edit", compact('collegeMajor'));
    }
