...
class StudentScoreController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.admin.student-score.index', compact('studentScores'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.admin.student-score.create", [
            "criterias" => $criterias,
            "students" => $students
        ]);
    }
    ...
    //     return view("pages.admin.student-score.create-many", [
    ...
    public function show(StudentScore $studentScore)
    {
        ...
        return view("pages.admin.student-score.show", compact("studentScore"));
    }
    ...
    public function edit(StudentScore $studentScore)
    {
        ...
        return view("pages.admin.student-score.edit", [
