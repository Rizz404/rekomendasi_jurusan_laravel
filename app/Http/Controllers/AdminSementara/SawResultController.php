...
class SawResultController extends Controller
{
    ...
    public function myRecommendations()
    {
        ...
        return view('pages.recommendation.my-recommendations', compact('recommendations', 'student'));
    }
    ...
    //     return view('pages.admin.saw_results.index', compact('students'));
    // }
    ...
    //     return view('pages.admin.saw_results.show', compact('student', 'recommendations'));
    // }
