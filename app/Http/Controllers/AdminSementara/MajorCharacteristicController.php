...
class MajorCharacteristicController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.admin.major-characteristic.index', compact('majorCharacteristics'));
    }
    ...
    public function create(CollegeMajor $collegeMajor)
    {
        ...
        return view("pages.admin.major-characteristic.create", [
            "criterias" => $criterias,
    ...
    //     return view("pages.admin.major-characteristic.create-many", [
    //         "collegeMajor" => $collegeMajor,
    //         "criterias" => $criterias,
    //     ]);
    // }
    ...
    public function show(MajorCharacteristic $majorCharacteristic)
    {
        ...
        return view("pages.admin.major-characteristic.show", compact("majorCharacteristic"));
    }
    ...
    public function edit(MajorCharacteristic $majorCharacteristic)
    {
        ...
        return view("pages.admin.major-characteristic.edit", [
